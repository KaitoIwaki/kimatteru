...
export const RELEASE_NOTES = [
  {
    ...
    body: '応援してくださった合計に応じて、カードの紙と箔が変わります。ノーマル（生成りの紙に真鍮）、¥1,000 からゴールド、¥3,000 からブラックの3段です。カードの下に、次の段まであといくらかを出しています。段が上がっても機能は増えません。見た目だけです。カードは指でなぞると、なぞった分だけその場で回ります。途中で手を離せば近いほうの面に落ち着き、勢いよく払えば向こうまで回ります。押して裏返すこともできます。上下になぞったときは裏返りませんが、指について少しだけ寝ます。',
  },
  {
    version: '0.20.0',
