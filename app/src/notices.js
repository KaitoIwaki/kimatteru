...
export const RELEASE_NOTES = [
  {
    ...
    body: 'このアプリは iPhone のカレンダー本体を読んでいます。つまり Google だけでなく、Outlook、Microsoft 365、Yahoo!、会社や学校のカレンダーも、iPhone の設定にアカウントを足せば、そのまま取り込めます。これまでアプリのどこにも書いていなかったので、取り込みの画面に手順を置きました。予定が1件も見つからなかったときにも出ます。TimeTree やジョルテのように、アプリの中だけに予定を持っているものは、このやり方では出てきません。そちらは別の方法を考えています。',
  },
  {
    version: '0.22.3',
