...
export const RELEASE_NOTES = [
  {
    ...
    body: 'はじめての案内を短くし、1枚目を紙に字が現れる形にしました。毎日や毎週の予定を、まとめて置けるようになりました。予定に場所を入れておくと、開いたときに地図で開けます。メモには持ち物を書けます。この3つは予定を作る画面の「＋」から足すので、ふだんの画面は短いままです。カレンダーの年月をタップすると、離れた月へ一度に飛べます。「空いてる日をシェア」は、空き状況の画面に移しました。規約とプライバシーポリシーも、いまの中身に合わせて書き直しています。',
  },
  {
    version: '0.14.0',
